...
# Awesome OpenBSD Desktop 🐡 with stars
...
➡️ If you want more of these OpenBSD visuals, go check [here](https://github.com/raffaelschneider/openbsd-wallpapers) ⭐ 77 | 🐛 0 | 📅 2026-01-02 to get one of these wallpapers for yourself!
...
* [bspwm](https://github.com/baskerville/bspwm) ⭐ 8,306 | 🐛 348 | 🌐 C | 📅 2026-06-19 - A tiling window manager based on binary space partitioning.
* [spectrwm](https://github.com/conformal/spectrwm) ⭐ 1,405 | 🐛 33 | 🌐 C | 📅 2026-07-20 - A small dynamic tiling window manager for X11.
...
* [Ungoogled Chromium](https://github.com/ungoogled-software/ungoogled-chromium) ⭐ 27,501 | 🐛 184 | 🌐 Python | 📅 2026-08-21 - Chromium with Google services and telemetry removed. VA-API supported.
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,826 | 🐛 5 | 🌐 C | 📅 2026-08-17 - A tiny, lightning fast terminal file manager.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,475 | 🐛 83 | 🌐 Go | 📅 2026-08-24 - A terminal file manager written in Go, inspired by ranger.
* [PCManFM](https://github.com/lxde/pcmanfm) ⭐ 250 | 🐛 35 | 🌐 C | 📅 2026-02-03 - A lightweight file manager with tabbed browsing.
...
* [btop](https://github.com/aristocratos/btop) ⭐ 34,176 | 🐛 528 | 🌐 C++ | 📅 2026-08-23 - A modern resource monitor with a sleek interface.
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,916 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - Terminal bandwidth utilization tool.
...
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,550 | 🐛 180 | 🌐 Rust | 📅 2026-08-04 - A fast line-oriented search tool (rg).
* [bat](https://github.com/sharkdp/bat) ⭐ 60,239 | 🐛 423 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting.
* [tmux](https://github.com/tmux/tmux/wiki) ⭐ 48,784 | 🐛 30 | 🌐 C | 📅 2026-08-24 - A terminal multiplexer for managing multiple terminal sessions.
* [fd](https://github.com/sharkdp/fd) ⭐ 44,186 | 🐛 189 | 🌐 Rust | 📅 2026-08-11 - A simple, fast alternative to find.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,796 | 🐛 136 | 🌐 Rust | 📅 2026-08-24 - A smarter cd command.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,347 | 🐛 79 | 🌐 C | 📅 2026-08-23 - A fast system information tool (replaces archived neofetch).
* [eza](https://github.com/eza-community/eza) ⭐ 23,019 | 🐛 435 | 🌐 Rust | 📅 2026-08-06 - A modern replacement for ls.
...
* [OpenBSD Workstation for the People by Joel Carnat](https://www.tumfatig.net/2024/openbsd-workstation-for-the-people/)
...
* [Awesome OpenBSD](https://github.com/ligurio/awesome-openbsd) ⭐ 488 | 🐛 0 | 📅 2025-05-05 - A curated list of awesome OpenBSD resources.
