...
* [bspwm](https://github.com/baskerville/bspwm) ⭐ 8,303 | 🐛 348 | 🌐 C | 📅 2026-06-19 - A tiling window manager based on binary space partitioning.
* [spectrwm](https://github.com/conformal/spectrwm) ⭐ 1,402 | 🐛 33 | 🌐 C | 📅 2026-07-20 - A small dynamic tiling window manager for X11.
...
* [Ungoogled Chromium](https://github.com/ungoogled-software/ungoogled-chromium) ⭐ 27,431 | 🐛 181 | 🌐 Python | 📅 2026-08-12 - Chromium with Google services and telemetry removed. VA-API supported.
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,796 | 🐛 4 | 🌐 C | 📅 2026-08-16 - A tiny, lightning fast terminal file manager.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,467 | 🐛 81 | 🌐 Go | 📅 2026-08-15 - A terminal file manager written in Go, inspired by ranger.
* [PCManFM](https://github.com/lxde/pcmanfm) ⭐ 249 | 🐛 33 | 🌐 C | 📅 2026-02-03 - A lightweight file manager with tabbed browsing.
...
* [btop](https://github.com/aristocratos/btop) ⭐ 34,013 | 🐛 527 | 🌐 C++ | 📅 2026-08-08 - A modern resource monitor with a sleek interface.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,551 | 🐛 327 | 🌐 Go | 📅 2026-08-17 - A command-line fuzzy finder.
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,337 | 🐛 177 | 🌐 Rust | 📅 2026-08-04 - A fast line-oriented search tool (rg).
* [bat](https://github.com/sharkdp/bat) ⭐ 60,194 | 🐛 420 | 🌐 Rust | 📅 2026-08-11 - A cat clone with syntax highlighting.
* [tmux](https://github.com/tmux/tmux/wiki) ⭐ 48,664 | 🐛 45 | 🌐 C | 📅 2026-08-17 - A terminal multiplexer for managing multiple terminal sessions.
* [fd](https://github.com/sharkdp/fd) ⭐ 44,106 | 🐛 187 | 🌐 Rust | 📅 2026-08-11 - A simple, fast alternative to find.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,684 | 🐛 137 | 🌐 Rust | 📅 2026-08-10 - A smarter cd command.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,229 | 🐛 71 | 🌐 C | 📅 2026-08-17 - A fast system information tool (replaces archived neofetch).
* [eza](https://github.com/eza-community/eza) ⭐ 22,955 | 🐛 426 | 🌐 Rust | 📅 2026-08-06 - A modern replacement for ls.
...
* [Awesome OpenBSD](https://github.com/ligurio/awesome-openbsd) ⭐ 493 | 🐛 0 | 📅 2025-05-05 - A curated list of awesome OpenBSD resources.
