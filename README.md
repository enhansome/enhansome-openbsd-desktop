...
* [Ungoogled Chromium](https://github.com/ungoogled-software/ungoogled-chromium) ⭐ 27,729 | 🐛 180 | 🌐 Python | 📅 2026-09-17 - Chromium with Google services and telemetry removed. VA-API supported.
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,892 | 🐛 2 | 🌐 C | 📅 2026-09-16 - A tiny, lightning fast terminal file manager.
* [lf](https://github.com/gokcehan/lf) ⭐ 9,516 | 🐛 84 | 🌐 Go | 📅 2026-09-15 - A terminal file manager written in Go, inspired by ranger.
...
* [btop](https://github.com/aristocratos/btop) ⭐ 34,637 | 🐛 542 | 🌐 C++ | 📅 2026-09-18 - A modern resource monitor with a sleek interface.
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 83,099 | 🐛 329 | 🌐 Go | 📅 2026-09-14 - A command-line fuzzy finder.
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 68,400 | 🐛 199 | 🌐 Rust | 📅 2026-08-04 - A fast line-oriented search tool (rg).
* [bat](https://github.com/sharkdp/bat) ⭐ 60,492 | 🐛 518 | 🌐 Rust | 📅 2026-09-04 - A cat clone with syntax highlighting.
* [tmux](https://github.com/tmux/tmux/wiki) ⭐ 49,324 | 🐛 47 | 🌐 C | 📅 2026-09-17 - A terminal multiplexer for managing multiple terminal sessions.
* [fd](https://github.com/sharkdp/fd) ⭐ 44,472 | 🐛 200 | 🌐 Rust | 📅 2026-09-16 - A simple, fast alternative to find.
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 39,553 | 🐛 146 | 🌐 Rust | 📅 2026-09-14 - A smarter cd command.
* [fastfetch](https://github.com/fastfetch-cli/fastfetch) ⭐ 24,679 | 🐛 92 | 🌐 C | 📅 2026-09-18 - A fast system information tool (replaces archived neofetch).
* [eza](https://github.com/eza-community/eza) ⭐ 23,309 | 🐛 452 | 🌐 Rust | 📅 2026-08-06 - A modern replacement for ls.
